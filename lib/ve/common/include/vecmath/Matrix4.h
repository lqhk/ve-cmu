...
#include <vecmath/Quat4.h>      // not very good. use temlate export later
#include <vecmath/AxisAngle4.h>
#include <vecmath/Matrix4_.h>
#include <vecmath/Matrix3.h>   // not very good. use template export later
