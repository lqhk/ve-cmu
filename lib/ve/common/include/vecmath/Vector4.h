...
public:
    ...
    T lengthSquared() const {
        return Tuple4<T>::x*Tuple4<T>::x + Tuple4<T>::y*Tuple4<T>::y + Tuple4<T>::z*Tuple4<T>::z + Tuple4<T>::w*Tuple4<T>::w;
    }
    ...
    T dot(const Vector4& v1) const {
        return Tuple4<T>::x*v1.x + Tuple4<T>::y*v1.y + Tuple4<T>::z*v1.z + Tuple4<T>::w*v1.w;
    }
