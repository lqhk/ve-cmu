...
public:
    ...
    T distanceL1(const Point3& p1) const {
        return VmUtil<T>::abs(Tuple3<T>::x-p1.x) + VmUtil<T>::abs(Tuple3<T>::y-p1.y) + VmUtil<T>::abs(Tuple3<T>::z-p1.z);
    }
    ...
    T distanceLinf(const Point3& p1) const {
        return VmUtil<T>::max(VmUtil<T>::abs(Tuple3<T>::x-p1.x), VmUtil<T>::abs(Tuple3<T>::y-p1.y), VmUtil<T>::abs(Tuple3<T>::z-p1.z));
    }
