...
#include <vecmath/VmUtil.h>
#include <vecmath/Tuple4.h>
...
/**
  ...
  * @version specification 1.1, implementation $Revision: 1.1 $, $Date: 2004/05/14 14:34:21 $
...
/*
 * $Log: Point4.h,v $
 * Revision 1.1  2004/05/14 14:34:21  yosimoto
 * *** empty log message ***
 *
...
public:
    ...
    T distanceL1(const Point4& p1) const {
        return VmUtil<T>::abs(Tuple4<T>::x-p1.x) + VmUtil<T>::abs(Tuple4<T>::y-p1.y)
	    + VmUtil<T>::abs(Tuple4<T>::z-p1.z) + VmUtil<T>::abs(Tuple4<T>::w-p1.w);
    }
    ...
    T distanceLinf(const Point4& p1) const {
        return VmUtil<T>::max(VmUtil<T>::abs(Tuple4<T>::x-p1.x), VmUtil<T>::abs(Tuple4<T>::y-p1.y), VmUtil<T>::abs(Tuple4<T>::z-p1.z), VmUtil<T>::abs(Tuple4<T>::w-p1.w));
    }
